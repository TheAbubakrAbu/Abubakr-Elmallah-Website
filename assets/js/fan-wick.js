...
window.FAN_PAGE = {
  ...
  { id: 'films', kind: 'films', title: 'The Four', note: 'Chad Stahelski · 2014 onward',
    ...
    items: [
      { num: 'I', title: 'John Wick', sub: 'October 2014', accent: '#d84a52',
        ...
        meta: 'Set over about five days · the best-shot debut of the decade' },
      { num: 'II', title: 'Chapter 2', sub: 'February 2017', accent: '#c94a5a',
        ...
        meta: 'Set four days after the first · the world opens up' },
      { num: 'III', title: 'Parabellum', sub: 'May 2019', accent: '#a83a4a',
        ...
        meta: 'Picks up one hour after Chapter 2 · si vis pacem, para bellum' },
      { num: 'IV', title: 'Chapter 4', sub: 'March 2023', accent: '#e05a62',
        ...
        meta: 'Set some months later · the one they were building to' },
    ] },
  ...
  { id: 'themes', kind: 'tiles', compact: true, title: 'The Themes', note: 'eight tracks · the club, the theme, and the name',
    lede: 'Two composers and one DJ. Tyler Bates and Joel J. Richard write the score; Le Castle Vania writes the parts you remember, which is why the fights sound like a nightclub that has gone badly wrong. Linked to the artists’ own uploads wherever there is one.',
    items: [
      { title: 'Story of Wick', accent: '#c9ced6', sub: 'Tyler Bates & Joel J. Richard · John Wick · 2014 · 3:05',
        desc: 'The main theme: a guitar played like a threat.',
        href: 'https://www.youtube.com/watch?v=hYNPXMobaTY', link: 'Listen' },
      { title: 'Baba Yaga', accent: '#a8323c', sub: 'Tyler Bates & Joel J. Richard · John Wick · 2014 · 1:46',
        desc: 'The name Viggo gives him on the phone to his son, and the one the whole franchise is built on. Not the boogeyman: the one you send to kill the boogeyman.',
        href: 'https://www.youtube.com/watch?v=zD3vV1u_BEM', link: 'Listen' },
      { title: 'On The Hunt', accent: '#8f5f6a', sub: 'Tyler Bates & Joel J. Richard · John Wick · 2014 · 2:13',
        desc: 'The house, the basement floor coming up, and a man getting his tools back out. Two minutes of somebody deciding.',
        href: 'https://www.youtube.com/watch?v=TY-tFLFrE78', link: 'Fan upload' },
      { title: 'LED Spirals', accent: '#d84a52', sub: 'Le Castle Vania · John Wick · 2014 · 3:16',
        desc: 'The first half of the Red Circle sequence: the bathhouse, the stairs, and the track that decided what this whole series would sound like.',
        href: 'https://www.youtube.com/watch?v=7Pv0u7uMn-g', link: 'Listen' },
      { title: 'Shots Fired', accent: '#d84a52', sub: 'Le Castle Vania · John Wick · 2014 · 3:12',
        desc: 'The other half of the Red Circle club fight, and the reason every gunfight in the series since sounds like a rave.',
        href: 'https://www.youtube.com/watch?v=JpwTx4G2EAM', link: 'Listen' },
      { title: 'John Wick Mode', accent: '#c04a6a', sub: 'Le Castle Vania · John Wick: Chapter 2 · 2017 · 3:05',
        desc: 'Written for the second film’s catacombs sequence, and named after the state everyone in the audience wanted him to enter. The best thing on either soundtrack.',
        href: 'https://www.youtube.com/watch?v=4o2EU5VOzLQ', link: 'Listen' },
      { title: 'Excomunicado', accent: '#6f7f9f', sub: 'Tyler Bates & Joel J. Richard · Chapter 3: Parabellum · 2019 · 1:26',
        desc: 'The word the Continental’s switchboard puts out over the wire at six o’clock, and the moment fourteen million dollars of open contract lands on him. Ninety seconds, and the best world-building in the series is a paperwork sound.',
        href: 'https://www.youtube.com/watch?v=gl1xkIUDZRA', link: 'Listen' },
      { title: 'Change Your Nature', accent: '#b0704a', sub: 'Tyler Bates & Joel J. Richard · Chapter 4 · 2023 · 1:47',
        desc: 'From the fourth film, and the line the Elder puts to him in the first one: a man can change his nature, or he can be what he is. The score finally answering it.',
        href: 'https://www.youtube.com/watch?v=XAhSGOL8TA8', link: 'Listen' },
    ] },
