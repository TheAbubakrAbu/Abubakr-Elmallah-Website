...
window.FAN_PAGE = {
  ...
  { id: 'lines', kind: 'quotes', title: 'Lines', note: 'the ones that stuck',
    items: [
      { title: 'I must not fear. Fear is the mind-killer.', sub: 'The Litany Against Fear' },
      { title: 'The spice must flow.', sub: 'The Imperium' },
      { title: 'He who controls the spice controls the universe.', sub: 'Baron Harkonnen' },
