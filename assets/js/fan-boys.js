...
window.FAN_PAGE = {
  ...
  { id: 'themes', kind: 'tiles', compact: true, title: 'The Themes & Songs', note: 'nine tracks · from my playlist',
    lede: 'The title theme, the little Homelander violin meme cue, a few perfect Vought pop songs, the Chumbawamba needle-drop off the end of season five, Piano Man over the very last scene of the series, and the sped-up Party in the U.S.A. edit. Three Billy Joel tracks in here, which is not a coincidence.',
    items: [
      ...
      { title: 'Homelander in Hallway', accent: '#c9a05f', sub: 'Christopher Lennertz · Season 2 · 2020 · 0:34',
        ...
        links: [
          { href: 'https://www.youtube.com/watch?v=s66K4rcKrs4', label: 'Listen' },
          { href: 'https://music.amazon.com/tracks/B08KL3TWZ7', label: 'Amazon Music' },
        ] },
      { title: 'Never Truly Vanish', accent: '#f0c840', sub: 'Erin Moriarty · Season 2 · 2020',
        ...
        links: [
          { href: 'https://www.youtube.com/watch?v=_Kie5rK6_OU', label: 'Listen' },
          { href: 'https://www.youtube.com/watch?v=Rw_OHwI5dUQ', label: 'Music video' },
        ] },
      { title: 'Faster', accent: '#5f9fd0', sub: 'Jessie T. Usher & Aimée Proal · Season 2 · 2020',
        ...
        links: [
          { href: 'https://www.youtube.com/watch?v=-mVCysocsd8', label: 'Listen' },
          { href: 'https://www.youtube.com/watch?v=Tcd-rwe-SEw', label: 'Music video' },
        ] },
      { title: 'Pressure', accent: '#e0603a', sub: 'Billy Joel · Season 2 · 2020',
        desc: 'The Billy Joel needle-drop: pressure, then worse pressure.',
        href: 'https://www.youtube.com/watch?v=Iyv905Q2omU', link: 'Listen' },
      { title: 'We Didn’t Start the Fire', accent: '#e0483a', sub: 'Billy Joel · Season 2 · 2020',
        ...
        href: 'https://www.youtube.com/watch?v=eFTLKWw542g', link: 'Listen' },
      { title: 'Tubthumping', accent: '#e0a83a', sub: 'Chumbawamba · Season 5 · 2026 · 3:34',
        desc: 'I get knocked down, but I get up again. Chumbawamba over the end of “Teenage Kix”, and the most on-the-nose the show has ever been about what Butcher actually is: the man who keeps getting back up long past the point where that is a good thing.',
        href: 'https://www.youtube.com/watch?v=2H5uWRjFsGc', link: 'Listen' },
      ...
      { title: 'Party in the U.S.A. (Sped Up)', accent: '#6f9fd0', sub: 'Miley Cyrus · The Boys meme edit',
        ...
        links: [
          ...
          { href: 'https://open.spotify.com/search/Party%20in%20the%20U.S.A.%20Miley%20Cyrus', label: 'On Spotify' },
        ] },
    ] },
