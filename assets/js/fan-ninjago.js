...
window.FAN_PAGE = { sections: [
  ...
  { id: 'ninja', kind: 'cards', title: 'The Ninja', note: 'one element each',
    items: [
      { title: 'Kai', sub: 'Master of Fire', tag: 'Red', desc: 'The hothead who was a blacksmith first, and the one who charges in before the plan is finished.', meta: 'Fire · Ignacia' },
      { title: 'Jay', sub: 'Master of Lightning', tag: 'Blue', desc: 'Inventor, motormouth, and the comic relief that keeps turning out to matter.', meta: 'Lightning · junkyard' },
      { title: 'Cole', sub: 'Master of Earth', tag: 'Black', desc: 'The strongest and the steadiest: a dancer before he was a ninja, which the show never lets him forget.', meta: 'Earth · Royal Blacksmiths' },
      { title: 'Zane', sub: 'Master of Ice', tag: 'White', desc: 'A Nindroid who did not know it, and the first of them to die and come back different.', meta: 'Ice · the Titanium Ninja' },
      { title: 'Lloyd', sub: 'The Green Ninja', tag: 'Green', desc: 'The prophesied one, son of the villain, and the character the whole sixteen-season arc grows around.', meta: 'Energy · Garmadon’s son' },
