...
window.FAN_PAGE = {
  ...
  { id: 'dragons', kind: 'tiles', fold: true, title: 'The Dragons', note: 'the Book of Dragons, abridged', compact: true,
    ...
    items: [
      ...
      { title: 'Bewilderbeast', accent: '#8fd8f0', sub: 'Tidal class', desc: 'The alpha: a mountain with tusks that exhales winter. When it appears, every other dragon on screen bows.' },
    ] },
  ...
  { id: 'score', kind: 'cards', title: 'The Score', note: 'John Powell, doing the flying',
    ...
    items: [
      { title: 'Test Drive', sub: 'The one everyone knows', tag: 'Film 1', accent: '#7fd0e8',
        ...
        href: 'https://www.youtube.com/watch?v=IpPIK4T068s', link: 'Listen', meta: 'The franchise in 2:35' },
      { title: 'Forbidden Friendship', sub: 'The quiet one', tag: 'Film 1', accent: '#5fa86f',
        desc: 'No dialogue for four minutes: a boy, a dragon, and a line drawn in the sand. Pizzicato and hammered dulcimer doing the trust-building the script wisely refused to put into words.',
        href: 'https://www.youtube.com/watch?v=96NgGuKQcmo', link: 'Listen', meta: 'The best scene' },
      { title: 'Romantic Flight', sub: 'The clouds one', tag: 'Film 1', accent: '#c9a0e8',
        desc: 'Astrid stops screaming, the strings open up, and the film sells its entire premise in one sunset. Shameless and completely earned.',
        href: 'https://www.youtube.com/watch?v=ZJR8tuO-mIU', link: 'Listen', meta: 'Strings, unashamed' },
      ...
      { title: 'Flying With Mother', sub: 'The one that got me', tag: 'Film 2', accent: '#8fc0d8',
  ...
  { id: 'quotes', kind: 'quotes', title: 'Lines', note: 'the two that carry it',
    items: [
      { title: 'Everything we know about you guys… is wrong.', sub: 'Hiccup · How to Train Your Dragon', accent: '#7fd0e8' },
  ...
  { id: 'themes', kind: 'tiles', compact: true, title: 'The Themes', note: 'eight tracks · John Powell, all three films',
    lede: 'John Powell got an Oscar nomination for the first one and should have won it. Scottish folk played by a ninety-piece orchestra, and the flight scenes work because the camera and the orchestra are the same instrument. Two of these are on my playlist, as a Samuel Kim arrangement and a fan upload called "Flying theme"; these are Powell’s own.',
    items: [
      { title: 'This Is Berk', accent: '#7fd0e8', sub: 'How to Train Your Dragon · 2010 · 4:11',
        desc: 'The opening narration and the dragon raid. This is the main theme, whatever a given upload calls it: everything titled "the How to Train Your Dragon theme" is some cut of this cue.',
        href: 'https://www.youtube.com/watch?v=hNFM2f4BvAo', link: 'Listen' },
      { title: 'Forbidden Friendship', accent: '#5fa86f', sub: 'How to Train Your Dragon · 2010 · 4:12',
        desc: 'No dialogue for four minutes: a boy, a dragon, a fish, and a line drawn in the sand. Pizzicato and hammered dulcimer doing the trust-building the script wisely refused to put into words. The best scene in the trilogy.',
        href: 'https://www.youtube.com/watch?v=96NgGuKQcmo', link: 'Listen' },
      { title: 'Test Drive', accent: '#7fd0e8', sub: 'How to Train Your Dragon · 2010 · 2:35',
        desc: 'The first proper flight with the new tail fin, and the theme assembling itself mid-air as the two of them work out the mechanics. The single best marriage of music and animation this century.',
        href: 'https://www.youtube.com/watch?v=IpPIK4T068s', link: 'Listen' },
      { title: 'Romantic Flight', accent: '#c9a0e8', sub: 'How to Train Your Dragon · 2010 · 1:57',
        desc: 'Astrid stops screaming, the strings open up, and the film sells its entire premise in one sunset. Shameless and completely earned.',
        href: 'https://www.youtube.com/watch?v=ZJR8tuO-mIU', link: 'Listen' },
      { title: 'Together We Map The World', accent: '#e8c56a', sub: 'How to Train Your Dragon 2 · 2014 · 2:19',
        desc: 'The opening of the second film: five years on, Hiccup and Toothless filling in the edges of the map because there is nothing left to be afraid of. The last easy scene in the trilogy.',
        href: 'https://www.youtube.com/watch?v=PRtQNXcHtxA', link: 'Listen' },
      { title: 'Flying With Mother', accent: '#8fc0d8', sub: 'How to Train Your Dragon 2 · 2014 · 2:50',
        desc: 'Valka and Hiccup in the air over the nest, and twenty years of not knowing each other closed in a wordless flight. The sequel’s answer to Forbidden Friendship.',
        href: 'https://www.youtube.com/watch?v=iX5SZTNetx8', link: 'Listen' },
      { title: 'Where No One Goes', accent: '#e8c56a', sub: 'Jónsi · How to Train Your Dragon 2 · 2014 · 2:45',
        desc: 'Powell with Jónsi of Sigur Rós, over the flight-suit sequence. The moment the sequel announces it intends to be bigger, and briefly is.',
        href: 'https://www.youtube.com/watch?v=EnSN9PYPldA', link: 'Listen' },
      { title: 'Once There Were Dragons', accent: '#c9a0e8', sub: 'The Hidden World · 2019 · 5:46',
        desc: 'The goodbye: Toothless going down into the Hidden World, then the jump forward to Hiccup’s own children meeting him again. The trilogy sticking its landing, and the reason the third film is allowed to be the weakest and still the right ending.',
        href: 'https://www.youtube.com/watch?v=WbsI4OMwh-w', link: 'Listen' },
    ] },
  ...
  { id: 'links', kind: 'links', title: 'Links', note: 'the Book of Dragons, online',
    items: [
      { title: 'On Wikipedia', href: 'https://en.wikipedia.org/wiki/How_to_Train_Your_Dragon',
        desc: 'The franchise: the Cressida Cowell books, three films, the series and the remake.' },
      { title: 'How to Train Your Dragon Wiki', href: 'https://howtotrainyourdragon.fandom.com/wiki/How_to_Train_Your_Dragon_Wiki',
        desc: 'Every dragon class, every rider, every island in the archipelago.' },
      { title: 'John Powell’s score', href: 'https://en.wikipedia.org/wiki/How_to_Train_Your_Dragon_(soundtrack)',
        desc: 'The Oscar-nominated soundtrack, and where to start with it (Test Drive).' },
    ] },
