...
window.FAN_PAGE = {
  ...
  { id: 'themes', kind: 'tiles', compact: true, title: 'The Themes', note: 'twenty-eight tracks · lobby, dances, memes',
    lede: 'The sound of Chapter 1: the lobby tracks that played before every match, the emotes the whole school knew the moves to, and the two songs the internet made out of the game afterwards. Every season number here is the one Epic’s own cosmetics data gives, so the order is the order they actually arrived in. Grouped by what they are, sorted by season.',
    groupable: { key: 'series', label: 'Group', on: 'By kind', open: 'on' },
    ...
    items: [
      { title: 'OG Lobby Music', series: 'Lobby music', season: 1, secs: 116, accent: '#6fb0ff', sub: 'Default lobby · Chapter 1 · 2017 · 1:56',
      ...
      { title: 'Squeaky Clean', series: 'Lobby music', season: 6, secs: 189, accent: '#8fe08f', sub: 'Lobby music · Chapter 1 Season 6 · 3:09',
        desc: 'The Floss, stretched into a full lobby track for the Season 6 battle pass. The dance got banned from more school hallways than any other, and this is the version you had to listen to while queueing.',
        href: 'https://www.youtube.com/watch?v=_Bv-ofwDB84', link: 'Fan upload' },
      { title: 'Coral Chorus', series: 'Lobby music', season: 8, secs: 150, accent: '#4fd0c0', sub: 'Lobby music · Chapter 1 Season 8 · 2:30',
        desc: 'Pirates, volcanoes and steel drums. The one lobby theme that could stand next to the original.',
        href: 'https://www.youtube.com/watch?v=FW3JleDWvpc', link: 'Fan upload' },
      { title: 'Star Power', series: 'Lobby music', season: 8, secs: 140, accent: '#f0d040', sub: 'Lobby music · Chapter 1 Season 8 · 2:20',
      ...
      { title: 'Dance Moves', series: 'Dances', season: 1, secs: 31, accent: '#c0c8d8', sub: 'Default emote · Chapter 1 Season 1 · 0:31',
        desc: 'The default dance. Free, on every account, never taken away, and the single most recognisable thing the game ever produced. Four versions, all of them here.',
        href: 'https://www.youtube.com/watch?v=4RUGDvN1GWU', link: 'Fan upload' },
      { title: 'Electro Shuffle', series: 'Dances', season: 1, secs: 115, accent: '#7fd0f0', sub: 'Epic emote · Chapter 1 Season 1 · 1:55',
        desc: 'From the very first season, and still one of the best pieces of music attached to a dance in the game.',
        href: 'https://www.youtube.com/watch?v=CykBcZHAoJU', link: 'Fan upload' },
      { title: 'Floss', series: 'Dances', season: 2, secs: 110, accent: '#8fe08f', sub: 'Rare emote · Chapter 1 Season 2 · 1:50',
        desc: 'The Backpack Kid’s dance, bought into the game in Season 2, and the one every parent in the country learned to recognise from across a room.',
        href: 'https://www.youtube.com/watch?v=W3nBThUHQKg', link: 'Fan upload' },
      { title: 'Wiggle', series: 'Dances', season: 3, secs: 166, accent: '#e07fd0', sub: 'Rare emote · Chapter 1 Season 3 · 2:46',
        desc: 'The shoulder one. Got its own lobby music pack two years later, which is how you know it stuck.',
        href: 'https://www.youtube.com/watch?v=hNBSKi6wQEk', link: 'Fan upload' },
      { title: 'Reanimated', series: 'Dances', season: 3, secs: 145, accent: '#a06fd0', sub: 'Epic emote · Chapter 1 Season 3 · 2:25',
        desc: 'Thriller, essentially, and the first emote that felt like Epic had a budget.',
        href: 'https://www.youtube.com/watch?v=AZg8NDibed4', link: 'Fan upload' },
      { title: 'Best Mates', series: 'Dances', season: 3, secs: 125, accent: '#f0a03a', sub: 'Rare emote · Chapter 1 Season 3 · 2:05',
        desc: 'The one everybody did in the lobby while waiting for the bus, in a line, badly.',
        href: 'https://www.youtube.com/watch?v=yi15xubpOfU', link: 'Fan upload' },
      { title: 'Take the L', series: 'Dances', season: 3, secs: 127, accent: '#c060e0', sub: 'Rare emote · Chapter 1 Season 3 · 2:07',
      ...
      { title: 'Orange Justice', series: 'Dances', season: 4, secs: 152, accent: '#f08030', sub: 'Rare emote · Chapter 1 Season 4 · 2:32',
      ...
      { title: 'Infinite Dab', series: 'Dances', season: 4, secs: 140, accent: '#5fc0a0', sub: 'Rare emote · Chapter 1 Season 4 · 2:20',
        desc: 'The dab, but it does not stop. Peak 2018, and unbearable now in a way I fully accept responsibility for.',
        href: 'https://www.youtube.com/watch?v=Ly8w1FN-IlE', link: 'Fan upload' },
      { title: 'Hype', series: 'Dances', season: 4, secs: 135, accent: '#e04a80', sub: 'Rare emote · Chapter 1 Season 4 · 2:15',
        desc: 'Two and a quarter minutes of a loop that has no business being as good as it is.',
        href: 'https://www.youtube.com/watch?v=E8wKdPzI8_k', link: 'Fan upload' },
      { title: 'Freestylin\'', series: 'Dances', season: 4, secs: 398, accent: '#6fd0e0', sub: 'Epic emote · Chapter 1 Season 4 · 6:38',
        desc: 'The breakdance one, and the emote most likely to get you killed because it takes so long to finish.',
        href: 'https://www.youtube.com/watch?v=Ht0wnWJw4tU', link: 'Fan upload' },
      { title: 'Pop Lock', series: 'Dances', season: 4, secs: 150, accent: '#d0a040', sub: 'Epic emote · Chapter 1 Season 4 · 2:30',
        desc: 'Got remade into the Keep Poppin’ lobby pack later, which is the honour Epic reserves for the ones that sold.',
        href: 'https://www.youtube.com/watch?v=A-ISl4RpEjk', link: 'Fan upload' },
      { title: 'True Heart', series: 'Dances', season: 4, secs: 116, accent: '#e07f9f', sub: 'Epic emote · Chapter 1 Season 4 · 1:56',
        desc: 'Hands in a heart shape and a synth line that is far too sincere for a game where ninety-nine people are trying to kill you.',
        href: 'https://www.youtube.com/watch?v=GONbhEJtr4Y', link: 'Fan upload' },
      { title: 'Baller', series: 'Dances', season: 4, secs: 150, accent: '#f0c040', sub: 'Rare emote · Chapter 1 Season 4 · 2:30',
        desc: 'The basketball spin. Not to be confused with the Season 8 vehicle of the same name, which is Epic’s naming problem, not mine.',
        href: 'https://www.youtube.com/watch?v=Obo75o4H4-A', link: 'Fan upload' },
      { title: 'Boneless', series: 'Dances', season: 4, secs: 124, accent: '#8fd07f', sub: 'Rare emote · Chapter 1 Season 4 · 2:04',
        desc: 'The rubbery one. Two minutes of bass that got stuck in a lot of heads in the summer of 2018.',
        href: 'https://www.youtube.com/watch?v=6jAiLPzBNtY', link: 'Fan upload' },
      { title: 'Hula', series: 'Dances', season: 5, secs: 114, accent: '#5fd0a0', sub: 'Epic emote · Chapter 1 Season 5 · 1:54',
        desc: 'Season 5, the one with the rifts and the desert, and an emote that sounds like nothing else in the game.',
        href: 'https://www.youtube.com/watch?v=ioprBXL7cz4', link: 'Fan upload' },
      { title: 'Swipe It', series: 'Dances', season: 5, secs: 133, accent: '#e0704a', sub: 'Rare emote · Chapter 1 Season 5 · 2:13',
        desc: 'The wiper-arms one. Simple, loud, and everywhere for about four months.',
        href: 'https://www.youtube.com/watch?v=bh_yWvO4zug', link: 'Fan upload' },
      { title: 'Electro Swing', series: 'Dances', season: 6, secs: 129, accent: '#c0a060', sub: 'Rare emote · Chapter 1 Season 6 · 2:09',
        desc: 'Season 6, and the one that got its own Electro-fied! lobby pack two seasons later.',
        href: 'https://www.youtube.com/watch?v=OwBKteIAu9I', link: 'Fan upload' },
      { title: 'Phone It In', series: 'Dances', season: 6, secs: 295, accent: '#e0a04a', sub: 'Epic emote · Chapter 1 Season 6 · 4:55',
        desc: 'A saxophone solo played on a mobile phone, which became the Saxy Groove lobby pack in Season 9. The single funniest emote in the game.',
        href: 'https://www.youtube.com/watch?v=2ET8t5CgEb4', link: 'Fan upload' },
      { title: 'T-Pose', series: 'Dances', season: 6, secs: 28, accent: '#c8ccd4', sub: 'Uncommon emote · Chapter 1 Season 6 · 0:28',
        desc: 'Epic sold people the animation bug. Stand still, arms out, choir underneath, assert dominance. Twenty-eight seconds and one of the great jokes in games.',
        href: 'https://www.youtube.com/watch?v=xSFwNnd1_Ro', link: 'Fan upload' },
      { title: 'Boogie Bomb', series: 'Dances', season: 1, secs: 63, accent: '#f0d040', sub: 'Item · Chapter 1 Season 1 · 1:03',
        desc: 'Not an emote: a grenade that makes everyone in the blast radius dance for five seconds whether they want to or not. The music is the same for all of them, and hearing it meant you had already lost the fight.',
        href: 'https://www.youtube.com/watch?v=fMgJIgT7gj4', link: 'Fan upload' },
      { title: 'Billy Bounce', series: 'Dances', season: 9, secs: 90, accent: '#7f9fe0', sub: 'Rare emote · Chapter 1 Season 9 · 1:30',
        desc: 'Season 9, near the end of the run that mattered, and the last emote from that era I actually remember buying.',
        href: 'https://www.youtube.com/watch?v=DpGf1SfeCEE', link: 'Fan upload' },
      { title: 'Chug Jug With You', series: 'Meme songs', season: 99, secs: 179, accent: '#e0c040', sub: 'Leviathan · 2020 · 2:59',
        desc: 'Number one victory royale. Leviathan’s parody of American Boy, written about drinking a chug jug, and somehow the most quoted piece of Fortnite audio that Epic had nothing to do with.',
        href: 'https://www.youtube.com/watch?v=Z0Uh3OJCx3o', link: 'Listen' },
      { title: 'Fishy On Me', series: 'Meme songs', season: 99, secs: 133, accent: '#4fc0d0', sub: 'Tiko · 2020 · 2:13',
        desc: 'Tiko, in the fish voice, about the Fishstick skin. A joke that ran so far it became a real music career.',
        href: 'https://www.youtube.com/watch?v=ZClu_I6U6aM', link: 'Listen' },
    ] },
