/* fan-minshawi.js: content for /worlds/minshawi/. Rendered by fanpage.js.
   ...
   The Qurʾān page carries the text's story; this page carries the voice.
   The Egyptian School section used to live on the Qurʾān page and moved
   here when he got a page of his own. */
window.FAN_PAGE = {
  ...
  { id: 'voice', kind: 'cards', title: 'The Voice', note: 'صوت من السماء',
    ...
    items: [
      { title: 'The ḥuzn', sub: 'The sorrow in it', tag: 'The signature', accent: '#d9b88a',
        ...
        meta: 'Grief and mercy at once' },
      { title: 'The restraint', sub: 'No showmanship', tag: 'The discipline', accent: '#3fd589',
        desc: 'Egyptian mujawwad rewards virtuosity, and the temptation of the era was to perform. He had the technique for all of it and spent it sparingly: a phrase turned over three ways, then released, always in service of the meaning rather than the melody.',
        meta: 'Technique, spent sparingly' },
      { title: 'The maqām sense', sub: 'Where the line breathes', tag: 'The craft', accent: '#e8c56a',
  ...
  { id: 'recordings', kind: 'cards', title: 'The Recordings', note: 'the catalogue, complete since 1969',
    ...
    items: [
      { title: 'The murattal muṣḥaf', sub: 'The complete Qurʾān, measured', tag: 'Start here', accent: '#3fd589',
        ...
        meta: 'The one on repeat' },
      { title: 'The mujawwad', sub: 'The high art, live', tag: 'The summit', accent: '#d9b88a',
        desc: 'Long, unhurried recordings in the ornamented style, mostly live with the congregation audibly responding. This is Egyptian recitation as performance-that-refuses-to-perform, and his Maryam and Yūsuf are the famous doors in.',
        meta: 'Maryam · Yūsuf · al-Fajr' },
  ...
  { id: 'school', kind: 'tiles', title: 'The Egyptian School', note: 'the company he keeps', compact: true,
    ...
    items: [
      { title: 'ʿAbd al-Bāsiṭ ʿAbd aṣ-Ṣamad', accent: '#e0b84f', sub: '1927–1988', desc: 'The most famous voice in the history of recitation, full stop. The breath control is not human.' },
      { title: 'Maḥmūd Khalīl al-Ḥuṣarī', accent: '#3fd589', sub: '1917–1980', desc: 'The precisionist. His phrase-by-phrase teaching recordings have taught more people tajwīd than any book.' },
      { title: 'Muṣṭafā Ismāʿīl', accent: '#5fa3ec', sub: '1905–1978', desc: 'The improviser: maqām shifts mid-āyah that musicians still study. The performers’ performer.' },
      { title: 'Muḥammad Rifʿat', accent: '#a05fd0', sub: '1882–1950', desc: 'The one the others grew up on. Blind from childhood; the earliest broadcast voice of the Qurʾān, 1934.' },
      { title: 'Ṣiddīq al-Minshāwī', accent: '#d9b88a', sub: 'The father', desc: 'A celebrated Qārī in his own right, and the first link: the son’s whole art started as the father’s apprentice.' },
      { title: 'Maḥmūd al-Minshāwī', accent: '#d9b88a', sub: 'The brother', desc: 'The third reciter in the house. One family, one craft, carried in parallel.' },
    ] },

  { id: 'links', kind: 'links', title: 'Links', note: 'where to actually hear him',
    items: [
      ...
      { title: 'Al-Quran, my app', href: 'https://apps.apple.com/us/developer/abubakr-elmallah/id1690310648',
        desc: 'The beginner Qurʾān app I built. The voice in this house is in its audio list, obviously.' },
    ] },
