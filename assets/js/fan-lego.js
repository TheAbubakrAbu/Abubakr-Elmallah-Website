...
window.FAN_PAGE = {
  ...
  /* `sortable` puts the order control above the tiles (see fanpage.js). The list
     below stays in TT Games' own order, newest first, because that is how they
     publish it; the page flips it to oldest-first on load so it opens on LEGO
     Star Wars 2005 and reads forwards from there.
  ...
  { id: 'catalogue', kind: 'tiles', title: 'The TT Games Catalogue', note: 'from ttgames.com/games', compact: true, cols: 3,
    tally: 'at 100%',
    ...
    items: [
      ...
      { title: 'The LEGO Movie 2 Videogame', accent: '#4fc0e0', year: 2019, proj: '16.5', sub: '2019 · Steam', desc: 'Building as a mechanic rather than a cutscene.' },
      { title: 'LEGO DC Super-Villains', accent: '#8f6fd0', year: 2018, proj: '41.8', sub: '2018 · Steam', desc: 'You play a custom villain. Easily the best idea they had in the late run.' },
      { title: 'LEGO The Incredibles', accent: '#e0642a', year: 2018, proj: '20.2', sub: '2018 · Steam', desc: 'Both films, and crime waves in the open world.' },
      { title: 'LEGO Marvel Super Heroes 2', accent: '#d01012', year: 2017, proj: '60.0', sub: '2017 · Steam', desc: 'Chronopolis, and Kang pulling eras together.' },
      { title: 'LEGO Ninjago Movie Game', accent: '#e0b040', year: 2017, proj: '17.8', sub: '2017 · Steam', desc: 'Tied to the film rather than the series, which is the problem with it.' },
      { title: 'LEGO Worlds', accent: '#00852b', year: 2017, proj: '36.7', sub: '2017 · Steam', desc: 'The sandbox one. Not a TT-formula game at all.' },
      { title: 'LEGO Star Wars: The Force Awakens', accent: '#ffd21f', year: 2016, proj: '30.8', sub: '2016 · Steam', desc: 'Multi-build, and blaster battles with cover.',
      ...
      { title: 'LEGO Marvel’s Avengers', accent: '#d01012', year: 2016, proj: '36.4', sub: '2016 · Steam', desc: 'Uses the actual film audio, which the silent ones never needed.' },
      { title: 'LEGO Dimensions', accent: '#8f6fd0', year: 2015, proj: '61.9', sub: '2015 · console only', desc: 'Toys-to-life with a physical portal you built and rebuilt. Never on Steam and never could have been: the hardware was the point.' },
      { title: 'LEGO Jurassic World', accent: '#e0642a', year: 2015, proj: '29.7', sub: '2015 · Steam', desc: 'All four films at the time, and you can play as the dinosaurs.' },
      { title: 'LEGO Batman 3: Beyond Gotham', accent: '#0055bf', year: 2015, proj: '35.9', sub: '2015 · Steam', desc: 'The Justice League in space, with the Lantern corps.' },
      { title: 'LEGO The Hobbit', accent: '#9a7a4a', year: 2014, proj: '36.8', sub: '2014 · Steam', desc: 'Only ever covered two of the three films. It just stops.' },
      { title: 'The LEGO Movie Videogame', accent: '#4fc0e0', year: 2014, proj: '17.6', sub: '2014 · Steam', desc: 'The film, and the instruction-following joke made playable.' },
      { title: 'LEGO Marvel Super Heroes', accent: '#d01012', year: 2013, proj: '39.5', sub: '2013 · Steam', desc: 'The best open world they built. Manhattan, properly.',
      ...
      { title: 'LEGO City Undercover', accent: '#00852b', year: 2013, proj: '48.8', sub: '2013 · Steam', desc: 'A LEGO game with actual voice acting, and a straight-faced police story.' },
      { title: 'LEGO Lord of the Rings', accent: '#d9b45f', year: 2012, proj: '33.6', sub: '2012 · Steam', desc: 'Used the film audio for the first time, and Middle-earth as one open map.' },
      { title: 'LEGO Batman 2: DC Super Heroes', accent: '#0055bf', year: 2012, proj: '24.1', sub: '2012 · Steam', desc: 'The first one with speech, and an open Gotham.' },
      { title: 'LEGO Harry Potter: Years 5–7', accent: '#d9b45f', year: 2011, proj: '24.8', sub: '2011 · Steam', desc: 'Darker, and the spell system is better than the first. Steam sells the two as one Collection, so the counter in the shot is the running total for both: 39.4 hours, of which this half was 19.5.',
      ...
      { title: 'LEGO Pirates of the Caribbean', accent: '#d8c9a0', year: 2011, proj: '23.0', sub: '2011 · Steam', desc: 'All four films at the time. Wildly underrated, and the quickest hundred percent of the lot.',
      ...
      { title: 'LEGO Star Wars III: The Clone Wars', accent: '#ffd21f', year: 2011, proj: '29.3', sub: '2011 · Steam', desc: 'Ground battles with commandable troops. Ambitious, and messy.',
      ...
      { title: 'LEGO Harry Potter: Years 1–4', accent: '#d9b45f', year: 2010, proj: '27.4', sub: '2010 · Steam', desc: 'Hogwarts as the hub, which is exactly right. The shot is the Collection paused after this half: 36 of the 84 achievements, all of them this game’s.',
      ...
      { title: 'LEGO Indiana Jones 2: The Adventure Continues', accent: '#c98f4f', year: 2009, proj: '20.5', sub: '2009 · Steam', desc: 'Includes a level builder, which almost nobody used.',
      ...
      { title: 'LEGO Batman: The Videogame', accent: '#0055bf', year: 2008, proj: '29.3', sub: '2008 · Steam', desc: 'Hero and villain campaigns, and still silent. Old enough to predate Steam achievements entirely.',
      ...
      { title: 'LEGO Indiana Jones: The Original Adventures', accent: '#c98f4f', year: 2008, proj: '19.3', sub: '2008 · Steam', desc: 'The one I played to death before I had seen the films, and the fastest hundred percent of the lot.',
      ...
      { title: 'LEGO Star Wars: The Complete Saga', accent: '#ffd21f', year: 2007, proj: '40.2', sub: '2007 · Steam', desc: 'All six films in one. The definitive version of the old formula.',
      ...
      { title: 'LEGO Star Wars II: The Original Trilogy', accent: '#ffd21f', year: 2006, proj: '29.6', sub: '2006', desc: 'Added character creation and vehicles.' },
      { title: 'LEGO Star Wars: The Video Game', accent: '#ffd21f', year: 2005, proj: '17.6', sub: '2005', desc: 'Where all of it starts.' },
    ] },
