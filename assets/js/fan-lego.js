...
window.FAN_PAGE = { sections: [
  ...
  { id: 'sets', kind: 'rank', title: 'The Big Ones', note: 'by piece count',
    items: [
      ...
      { title: 'Eiffel Tower', sub: '10,001 pieces · 2022', desc: 'A metre and a half tall, and the tallest set they have made.' },
      { title: 'Titanic', sub: '9,090 pieces · 2021', desc: 'Over a metre and a quarter long, in three cutaway sections.' },
      { title: 'Art Project, Create Together', sub: '4,138 pieces · 2021', desc: 'Nine canvases, arranged however you like.' },
      { title: 'Colosseum', sub: '9,036 pieces · 2020', desc: 'Three tiers of arches, and mostly tan.' },
      { title: 'Millennium Falcon (UCS)', sub: '7,541 pieces · 2017', desc: 'The one everyone means when they say the big Falcon.' },
      { title: 'Hogwarts Castle', sub: '6,020 pieces · 2018', desc: 'Microscale, with 27 microfigures and four minifigures.' },
      { title: 'Ninjago City', sub: '4,867 pieces · 2017', desc: 'Widely rated the best-designed modular building LEGO has ever put out.' },
    ] },
