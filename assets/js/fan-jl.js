...
window.FAN_PAGE = {
  ...
  { id: 'cartoons', kind: 'cards', title: 'The Cartoons', note: 'how I actually met these people',
    ...
    items: [
      ...
      { title: 'Teen Titans Go!', sub: '2013 – now', tag: 'Fire', accent: '#e0c040',
  ...
  { id: 'films', kind: 'cards', title: 'The Films', note: 'the ones I liked, against the consensus',
    ...
    items: [
      { title: 'Aquaman', sub: '2018 · Wan', tag: 'Loved', accent: '#3fb0a0',
        ...
        meta: '$1.15 billion' },
      { title: 'Aquaman and the Lost Kingdom', sub: '2023 · Wan', tag: 'Loved', accent: '#3fb0a0',
        ...
        meta: 'The last one' },
      { title: 'The Flash', sub: '2023 · Muschietti', tag: 'Loved', accent: '#e04a3a',
        ...
        meta: 'Keaton returns' },
      { title: 'Batman v Superman: Dawn of Justice', sub: '2016 · Snyder', tag: 'Liked', accent: '#8f9fb0',
        ...
        meta: 'Affleck' },
      { title: 'Justice League, both of them', sub: '2017 · 2021', tag: 'Liked', accent: '#5f9fe0',
