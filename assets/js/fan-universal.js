...
window.FAN_PAGE = { sections: [
  ...
  { id: 'parks', kind: 'cards', title: 'The Parks', note: 'Universal Destinations & Experiences',
    lede: 'Every Universal park and resort open or announced, with the parks inside each one.',
    items: [
  ...
  { id: 'lands', kind: 'tiles', title: 'The Lands', note: 'what Universal builds better than anyone',
    items: [
      { title: 'The Wizarding World', accent: '#c9a05f', sub: 'Since 2010', desc: 'Hogsmeade, Diagon Alley, a train between them in Orlando, and the bar that reset what a theme-park land could be.' },
