...
window.FAN_PAGE = {
  ...
  { id: 'themes', kind: 'tiles', compact: true, title: 'The Themes', note: 'twenty tracks · eight films',
    lede: 'The reason a lot of people can hum these films. David Julyan on The Prestige, Zimmer through the middle, Göransson from Tenet on, and the Dark Knight trilogy has its own list over on the Batman page. Grouped by film and sortable by release or length.',
    ...
    items: [
      { title: 'The Prestige', series: 'The Prestige', accent: '#b0a890', year: 2006, secs: 101, sub: 'David Julyan · The Prestige · 2006 · 1:41',
        desc: 'David Julyan, who scored Memento and Insomnia too and then never worked with Nolan again. Three sustained chords and almost nothing else, which is the correct amount of music for a film about not showing you the trick.',
        href: 'https://www.youtube.com/watch?v=zA8WdjTuzg4', link: 'Listen' },
      { title: 'The Dark Knight (Main Theme)', series: 'The Dark Knight', accent: '#e0a03a', year: 2008, secs: 463, sub: 'The Dark Knight · 2008 · 7:43',
        desc: 'Hans Zimmer and James Newton Howard. Two notes for Batman, one rising note for the Joker. A fan edit of the theme; on the album it runs through Like a Dog Chasing Cars and A Dark Knight. The rest of the trilogy is on the Batman page.',
        href: 'https://www.youtube.com/watch?v=iGx5a1ifSDs', link: 'Fan edit' },
      { title: 'Dream Is Collapsing', series: 'Inception', accent: '#8fa8c0', year: 2010, secs: 144, sub: 'Inception · 2010 · 2:24',
        desc: 'Hans Zimmer. The brass that every trailer copied for a decade, for the first dream coming apart around Cobb and Arthur.',
        href: 'https://www.youtube.com/watch?v=OzLhXesNkCI', link: 'Listen' },
      { title: 'Old Souls', series: 'Inception', accent: '#8fa8c0', year: 2010, secs: 465, sub: 'Inception · 2010 · 7:45',
        desc: 'Hans Zimmer. Limbo: Cobb and Mal’s fifty years on the beach, in the one cue on the album that is allowed to be sad rather than loud.',
        href: 'https://www.youtube.com/watch?v=LHNHgQxXs-c', link: 'Listen' },
      { title: 'Time', series: 'Inception', accent: '#8fa8c0', year: 2010, secs: 276, sub: 'Inception · 2010 · 4:35',
        desc: 'Hans Zimmer. The last cue in the film, and the one that made a generation of trailers sound like this: a four-chord climb that never quite arrives. The whole score is a slowed-down Non, je ne regrette rien, which is also the kick.',
        href: 'https://www.youtube.com/watch?v=c56t7upa8Bk', link: 'Listen' },
      { title: 'Dust', series: 'Interstellar', accent: '#d0d8e0', year: 2014, secs: 342, sub: 'Interstellar · 2014 · 5:42',
        desc: 'Hans Zimmer. The farm, the dust, and Murph’s bedroom. Nolan gave Zimmer one page about a father and a child and did not tell him it was a space film until the music was written.',
        href: 'https://www.youtube.com/watch?v=RHE8-GScz4s', link: 'Listen' },
      { title: 'Cornfield Chase', series: 'Interstellar', accent: '#d0d8e0', year: 2014, secs: 127, sub: 'Interstellar · 2014 · 2:07',
      ...
      { title: 'No Time For Caution', series: 'Interstellar', accent: '#d0d8e0', year: 2014, secs: 247, sub: 'Interstellar · 2014 · 4:07',
        desc: 'Hans Zimmer. The docking scene: the organ climbing while the Endurance spins, and the loudest four minutes he has written.',
        href: 'https://www.youtube.com/watch?v=kpK4cDk2bRs', link: 'Listen' },
      { title: 'S.T.A.Y.', series: 'Interstellar', accent: '#d0d8e0', year: 2014, secs: 384, sub: 'Interstellar · 2014 · 6:24',
        desc: 'Hans Zimmer. The tesseract: Cooper pushing the books off the shelf backwards through time to the daughter he left. Named for the word he spells out in the dust.',
        href: 'https://www.youtube.com/watch?v=Ia3eQ7QD9Z0', link: 'Listen' },
      { title: 'End Titles', series: 'Dunkirk', accent: '#8fa0a8', year: 2017, secs: 434, sub: 'Dunkirk · 2017 · 7:14',
        desc: 'Hans Zimmer, Benjamin Wallfisch and Lorne Balfe, over Elgar’s Nimrod pulled apart and rebuilt. The whole film is a Shepard tone that never stops climbing; this is the one place it is allowed to land.',
        href: 'https://www.youtube.com/watch?v=7RC9Ak9gz7s', link: 'Listen' },
      { title: 'Freeport', series: 'Tenet', accent: '#6f8fa0', year: 2020, secs: 219, sub: 'Tenet · 2020 · 3:39',
        desc: 'Ludwig Göransson, taking over from Zimmer because Zimmer was doing Dune. The Oslo freeport fight, with a man moving backwards through it and the music running backwards with him.',
        href: 'https://www.youtube.com/watch?v=yywzQbZcDL0', link: 'Listen' },
      { title: 'Trucks In Place', series: 'Tenet', accent: '#6f8fa0', year: 2020, secs: 333, sub: 'Tenet · 2020 · 5:33',
        desc: 'The motorway heist, and the best five minutes in the film: a reversed synth line under a car chase that is happening in two directions at once.',
        href: 'https://www.youtube.com/watch?v=NaSiqlwkK7U', link: 'Listen' },
      { title: 'Can You Hear The Music', series: 'Oppenheimer', accent: '#e0703a', year: 2023, secs: 111, sub: 'Oppenheimer · 2023 · 1:51',
      ...
      { title: 'Quantum Mechanics', series: 'Oppenheimer', accent: '#e0703a', year: 2023, secs: 181, sub: 'Oppenheimer · 2023 · 3:01',
        desc: 'Göransson built the score on a solo violin because Nolan wanted something that could be nervous, and this is where that decision pays: physics as anxiety.',
        href: 'https://www.youtube.com/watch?v=8TLR-TTXDY8', link: 'Listen' },
      { title: 'Manhattan Project', series: 'Oppenheimer', accent: '#e0703a', year: 2023, secs: 182, sub: 'Oppenheimer · 2023 · 3:02',
        desc: 'Los Alamos going up in the desert: a whole town built to do one thing, scored like a countdown that has not started yet.',
        href: 'https://www.youtube.com/watch?v=Ee-bpPsUeto', link: 'Listen' },
      { title: 'Destroyer Of Worlds', series: 'Oppenheimer', accent: '#e0703a', year: 2023, secs: 175, sub: 'Oppenheimer · 2023 · 2:55',
      ...
      { title: 'Odysseus', series: 'The Odyssey', accent: '#5fa8a0', year: 2026, secs: 522, sub: 'The Odyssey · 2026 · 8:42',
        desc: 'Ludwig Göransson. Eight and a half minutes for the man himself: the theme built out of a bronze-age tuning rather than a western one, which is the whole idea of this score.',
        href: 'https://www.youtube.com/watch?v=WCxx_OVOVUw', link: 'Listen' },
      { title: 'Sirens', series: 'The Odyssey', accent: '#5fa8a0', year: 2026, secs: 160, sub: 'The Odyssey · 2026 · 2:40',
        desc: 'Gongs, lyres and an aulos instead of an orchestra, for the one trial Odysseus has himself tied to the mast to survive.',
        href: 'https://www.youtube.com/watch?v=2_-XPMYQmXc', link: 'Listen' },
      { title: 'The Trial of the Bow / Vengeance', series: 'The Odyssey', accent: '#5fa8a0', year: 2026, secs: 374, sub: 'The Odyssey · 2026 · 6:14',
        desc: 'The suitors cannot string it, he can, and then the doors are shut. The bit worth waiting for is small: the string going taut, the two test plucks, and the one note the arrow leaves on. Everything after it is the vengeance half of the title.',
        href: 'https://www.youtube.com/watch?v=a5IQCGdd_m8', link: 'Listen' },
      { title: 'Ithaca', series: 'The Odyssey', accent: '#5fa8a0', year: 2026, secs: 342, sub: 'The Odyssey · 2026 · 5:42',
        desc: 'Home, twenty years late. The theme from Odysseus finally allowed to resolve, which Göransson holds off for the entire film.',
        href: 'https://www.youtube.com/watch?v=8DVfI_Muv_A', link: 'Listen' },
    ] },
