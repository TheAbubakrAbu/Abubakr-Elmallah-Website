...
window.FAN_PAGE = {
  ...
  { id: 'films', kind: 'rank', title: 'The Thirteen', note: '1998 – 2026 · in order · released, and set',
    ...
    items: [
      ...
      { title: 'The Dark Knight', sub: '2008', meta: 'Released July 2008 · Gotham, a year after Begins', desc: 'Ledger’s Joker, the first feature with sequences shot on IMAX cameras, and the film that made the genre respectable to people who dislike the genre.' },
      { title: 'Inception', sub: '2010', meta: 'Released July 2010 · contemporary, and decades deep in limbo', desc: 'A heist inside dreams inside dreams, with a rotating hallway built for real and a spinning top for an ending. Still the film people mean when they say Nolan.' },
      { title: 'The Dark Knight Rises', sub: '2012', meta: 'Released July 2012 · Gotham, eight years after The Dark Knight', desc: 'Bane, a plane pulled apart in the air for real, and the end of the trilogy. Bigger than the second one and not better, and it knows it.' },
  ...
  { id: 'mine', kind: 'films', title: 'The Big Five', note: 'the ones the rest are measured against',
    ...
    items: [
      { num: 'I', title: 'The Dark Knight', sub: 'July 2008', accent: '#e0a03a', meta: 'Bale · Ledger · Gotham, a year after Begins',
      ...
      { num: 'II', title: 'Inception', sub: 'July 2010', accent: '#8fa8c0', meta: 'DiCaprio · the top · contemporary, and decades inside limbo',
