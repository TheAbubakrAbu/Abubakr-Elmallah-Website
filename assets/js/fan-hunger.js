...
window.FAN_PAGE = {
  ...
  { id: 'books', kind: 'films', title: 'The Books', note: 'Suzanne Collins · published 2008 onward · the 10th Games to the 76th',
    ...
    items: [
      { num: 'I', title: 'The Hunger Games', sub: 'September 2008', accent: '#e0b040',
        ...
        meta: 'The 74th Hunger Games · the berries are the plot' },
      { num: 'II', title: 'Catching Fire', sub: 'September 2009', accent: '#e0763a',
        ...
        meta: 'The 75th Games, the Third Quarter Quell · the best of the five' },
      { num: 'III', title: 'Mockingjay', sub: 'August 2010', accent: '#8f9ab0',
        ...
        meta: 'The year after the 75th Games · deliberately unsatisfying' },
      { num: 'IV', title: 'The Ballad of Songbirds and Snakes', sub: 'May 2020', accent: '#4f7f5f',
        ...
        meta: 'The 10th Games, sixty-four years earlier · Snow lands on top' },
      { num: 'V', title: 'Sunrise on the Reaping', sub: 'March 2025', accent: '#c9a06f',
        ...
        meta: 'The 50th Games, the Second Quarter Quell, twenty-four years earlier · the one you already know' },
    ] },

  { id: 'films', kind: 'rank', title: 'The Films', note: 'Lionsgate · released 2012 onward · the 10th Games to the 76th',
    ...
    items: [
      { num: '12', title: 'The Hunger Games', sub: 'March 2012', accent: '#e0b040', meta: 'The 74th Hunger Games',
      ...
      { num: '13', title: 'Catching Fire', sub: 'November 2013', accent: '#e0763a', meta: 'The 75th Games, the Third Quarter Quell',
      ...
      { num: '14', title: 'Mockingjay, Part 1', sub: 'November 2014', accent: '#7f8894', meta: 'The months after the 75th Games',
      ...
      { num: '15', title: 'Mockingjay, Part 2', sub: 'November 2015', accent: '#8f9ab0', meta: 'The fall of the Capitol, and the epilogue years later',
      ...
      { num: '23', title: 'The Ballad of Songbirds and Snakes', sub: 'November 2023', accent: '#4f7f5f', meta: 'The 10th Games, sixty-four years before the first film',
  ...
  { id: 'themes', kind: 'tiles', compact: true, title: 'The Themes', note: 'seven tracks · the anthem, the score and the songs',
    lede: 'James Newton Howard scored all four, and the trick of it is that Panem’s official music and Katniss’s music are written by the same person to sound like they hate each other. These are the seven, linked to the albums’ own uploads.',
    items: [
      { title: 'Horn of Plenty', accent: '#e0b040', sub: 'James Newton Howard · The Hunger Games · 2012 · 2:00',
        desc: 'The Panem anthem, played at every reaping and every victory, and written to sound like a country with something to hide. The Capitol’s idea of a national tune.',
      ...
      { title: 'Rue\'s Farewell', accent: '#8fbf6a', sub: 'James Newton Howard · The Hunger Games · 2012 · 5:00',
        desc: 'The flowers, the three-finger salute, and District 11 rioting on a screen somewhere. The moment the first film stops being an action film.',
        href: 'https://www.youtube.com/watch?v=3vFcetpUIhM', link: 'Listen' },
      { title: 'There Are Worse Games To Play / Deep In The Meadow', accent: '#c07a5f', sub: 'James Newton Howard · Catching Fire · 2013 · 9:42',
        desc: 'The end-credits suite for the second film, running the lullaby Katniss sang to Rue straight into the main theme. Nine and a half minutes, and the best single piece of music in the series.',
        href: 'https://www.youtube.com/watch?v=NjhPFj1FjlY', link: 'Listen' },
      ...
      { title: 'Yellow Flicker Beat', accent: '#e0c040', sub: 'Lorde · Mockingjay, Part 1 · 2014 · 3:38',
        desc: 'The song over the credits of Mockingjay Part 1. Lorde curated that whole soundtrack at seventeen and wrote this one for Katniss specifically, which is why it is the only franchise end-credits single that sounds like it read the book.',
        href: 'https://www.youtube.com/watch?v=e1S9HUNoI4k', link: 'Listen' },
    ] },
