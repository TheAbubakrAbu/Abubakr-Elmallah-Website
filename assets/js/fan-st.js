...
window.FAN_PAGE = {
  ...
  { id: 'themes', kind: 'tiles', compact: true, title: 'The Themes', note: 'twenty-six tracks · five seasons',
    ...
    items: [
      ...
      { title: 'Home', series: 'Season 1', accent: '#e8261d', year: 2016, sub: 'Stranger Things, Vol. 1 · 2016',
        href: 'https://www.youtube.com/watch?v=BdcV1u6RUh4', link: 'Fan upload' },
      { title: 'Walking in Hawkins', series: 'Season 1', accent: '#e8261d', year: 2016, sub: 'Stranger Things, Vol. 1 · 2016',
        href: 'https://www.youtube.com/watch?v=mznlJCPdOKw', link: 'Fan upload' },
      { title: 'The Upside Down', series: 'Season 1', accent: '#e8261d', year: 2016, sub: 'Stranger Things, Vol. 1 · 2016',
        href: 'https://www.youtube.com/watch?v=vqffY-6OVKc', link: 'Listen' },
      { title: 'Biking to School', series: 'Season 1', accent: '#e8261d', year: 2016, sub: 'Stranger Things, Vol. 1 · 2016',
        href: 'https://www.youtube.com/watch?v=_KTsVwjeCec', link: 'Listen' },
      { title: 'Friendship', series: 'Season 1', accent: '#e8261d', year: 2016, sub: 'Stranger Things, Vol. 1 · 2016',
        href: 'https://www.youtube.com/watch?v=VW6FOP3q0Yo', link: 'Listen' },
      { title: 'Castle Byers', series: 'Season 1', accent: '#e8261d', year: 2016, sub: 'Stranger Things, Vol. 1 · 2016',
        href: 'https://www.youtube.com/watch?v=IFOldMEUCgU', link: 'Listen' },
      { title: 'Kids Two', series: 'Season 1', accent: '#e8261d', year: 2016, sub: 'Stranger Things, Vol. 2 · 2016',
        href: 'https://www.youtube.com/watch?v=9PydvdEdGwE', link: 'Listen' },
      ...
      { title: 'Soldiers', series: 'Season 2', accent: '#e0643a', year: 2017, sub: 'Stranger Things 2 · 2017',
        href: 'https://www.youtube.com/watch?v=rVe0pG5dnwY', link: 'Fan upload' },
      ...
      { title: 'I Like Presents Too', series: 'Season 3', accent: '#e05a9a', year: 2019, sub: 'Stranger Things 3 · 2019',
        href: 'https://www.youtube.com/watch?v=CLvjV6JAw0Q', link: 'Listen' },
      { title: 'You’re a Fighter', series: 'Season 3', accent: '#e05a9a', year: 2019, sub: 'Stranger Things 3 · 2019',
        href: 'https://www.youtube.com/watch?v=21Vdyg0kHmI', link: 'Listen' },
      { title: 'The Ceiling Is Beautiful', series: 'Season 3', accent: '#e05a9a', year: 2019, sub: 'Stranger Things 3 · 2019',
        href: 'https://www.youtube.com/watch?v=jphWJK6KxQ4', link: 'Listen' },
      { title: 'Rats', series: 'Season 3', accent: '#e05a9a', year: 2019, sub: 'Stranger Things 3 · 2019',
        href: 'https://www.youtube.com/watch?v=a59rptN4v20', link: 'Listen' },
      ...
      { title: 'Separate Ways (Worlds Apart)', series: 'Season 4', accent: '#8f4fd0', year: 2022, sub: 'Stranger Things 4 · 2022',
        href: 'https://www.youtube.com/watch?v=LatorN4P9aA', link: 'Listen' },
      { title: 'Being Different', series: 'Season 4', accent: '#8f4fd0', year: 2022, sub: 'Stranger Things 4 · 2022',
        href: 'https://www.youtube.com/watch?v=_o29YLtS_NA', link: 'Listen' },
      ...
      { title: 'One Final Spell', series: 'Season 5', accent: '#c9cdd2', year: 2025, sub: 'Stranger Things 5 · 2025',
        href: 'https://www.youtube.com/watch?v=iSnu7qOBLjM', link: 'Listen' },
      { title: 'Starr', series: 'Season 5', accent: '#c9cdd2', year: 2025, sub: 'Stranger Things 5 · 2025',
        href: 'https://www.youtube.com/watch?v=xz_XjK5l8lY', link: 'Listen' },
      { title: 'Holly the Heroic', series: 'Season 5', accent: '#c9cdd2', year: 2025, sub: 'Stranger Things 5 · 2025',
        href: 'https://www.youtube.com/watch?v=uq881QBdwE8', link: 'Listen' },
      { title: 'Like I Could Fly', series: 'Season 5', accent: '#c9cdd2', year: 2025, sub: 'Stranger Things 5 · 2025',
        href: 'https://www.youtube.com/watch?v=a_yD8ZrNDjc', link: 'Listen' },
    ] },

  { id: 'songs', kind: 'tiles', compact: true, title: 'The Songs Used in the Show', note: 'twelve songs · from my playlist',
    lede: 'The needle drops rather than the score: the songs that belong to Hawkins as much as the synths do.',
    groupable: { key: 'series', label: 'Group', on: 'By season', open: 'on' },
    sortable: { label: 'Sort', authored: 'asc', by: [
      { key: 'year', label: 'Released', asc: 'Oldest', desc: 'Newest' },
    ] },
    items: [
      { title: 'Should I Stay or Should I Go', sub: 'The Clash · Season 1', series: 'Season 1', year: 1982, accent: '#e8261d',
        href: 'https://www.youtube.com/watch?v=BN1WwnEDWAM', link: 'Listen' },
      { title: 'Heroes', sub: 'Peter Gabriel · Season 1', series: 'Season 1', year: 2010, accent: '#e8261d',
        href: 'https://www.youtube.com/watch?v=LsvuipGq2ns', link: 'Listen' },
      { title: 'Time After Time', sub: 'Cyndi Lauper · Season 2', series: 'Season 2', year: 1983, accent: '#e0643a',
        href: 'https://www.youtube.com/watch?v=7wBgcalM4c4', link: 'Listen' },
      { title: 'Never Ending Story', sub: 'Limahl · Season 3', series: 'Season 3', year: 1984, accent: '#e05a9a',
        href: 'https://www.youtube.com/watch?v=2WN0T-Ee3q4', link: 'Listen' },
      { title: 'Running Up That Hill (A Deal with God)', sub: 'Kate Bush · Season 4', series: 'Season 4', year: 1985, accent: '#8f4fd0',
        href: 'https://www.youtube.com/watch?v=wp43OdtAAkM', link: 'Listen' },
      { title: 'When It’s Cold I’d Like to Die', sub: 'Moby · Season 4', series: 'Season 4', year: 1995, accent: '#8f4fd0',
        href: 'https://www.youtube.com/watch?v=kFyuSMf-PtQ', link: 'Listen' },
      { title: 'Upside Down', sub: 'Diana Ross · Season 5', series: 'Season 5', year: 1980, accent: '#c9cdd2',
        href: 'https://www.youtube.com/watch?v=AI1CSySltfA', link: 'Listen' },
      { title: 'I Think We’re Alone Now', sub: 'Tiffany · Season 5', series: 'Season 5', year: 1987, accent: '#c9cdd2',
        href: 'https://www.youtube.com/watch?v=w6Q3mHyzn78', link: 'Listen' },
      { title: 'Mr. Sandman', sub: 'The Chordettes · Season 5', series: 'Season 5', year: 1954, accent: '#c9cdd2',
        href: 'https://www.youtube.com/watch?v=xatZLVL99BM', link: 'Listen' },
      { title: 'When Doves Cry', sub: 'Prince · Season 5', series: 'Season 5', year: 1984, accent: '#c9cdd2',
        href: 'https://www.youtube.com/watch?v=UG3VcCAlUgE', link: 'Listen' },
      { title: 'Purple Rain', sub: 'Prince · Season 5', series: 'Season 5', year: 1984, accent: '#c9cdd2',
        href: 'https://www.youtube.com/watch?v=uW1UIDYmYyI', link: 'Listen' },
      { title: 'Heroes', sub: 'David Bowie · Season 5', series: 'Season 5', year: 1977, accent: '#c9cdd2',
